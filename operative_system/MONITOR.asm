...
CALL MULTIPLY
    HLT; HLT provisional para que no se ejecute el programa de nuevo de aqui para abajo
...
;------- Parte del prepare ---------------
#ORG 1891H                                ;|  
#DB 07H,02H,40H,03H,08H // Multiplicando  ;|  
                                          ;|         
#ORG 1896H                                ;|
#DB 02H,09H,40H,04H,01H // Multiplicador  ;|
;----------------------------------------
