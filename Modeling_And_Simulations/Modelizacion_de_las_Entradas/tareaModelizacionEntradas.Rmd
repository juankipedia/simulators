...
Ambos gráficos lucen prácticamente igual, con esto no podemos tomar ninguna de las dos posibles candidatas ya que hasta ahora las pruebas realizadas muestran que podría ser cualquiera de las dos, por esto bservaremos los gráficos cuantil-cuantil antes de dar una hipótesis final.
...
###### Análisis: 
En este punto a pesar de que los últimos gráficos la gamma se ajusta muy ligeramente mejor a los datos, no descartaremos a la distribucion weibull ya que tambien representa muy bien los datos.
